    ...
    >
      <AnimatePresence mode="wait">
        {isExpanded ? (
            ...
            {showQueue ? (
              ...
              <>
                ...
                <div className="my-5 flex flex-col items-center justify-center">
                  ...
                  {/* Track Info */}
                  <div className="text-center mt-4 px-2 space-y-1 w-full">
          ...
          /* Collapsed Pill Floating Capsule */
          <motion.div
          ...
          >
            ...
            {/* Track Info Preview */}
            <div className="flex flex-col max-w-[130px] sm:max-w-[180px] min-w-0 pr-1 text-left">
            ...
            <button
              ...
              className="p-1.5 text-slate-400 hover:text-white transition-colors cursor-pointer hidden sm:block"
              title="Next Track"
              aria-label="Next track"
            >
